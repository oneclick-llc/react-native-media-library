...
class MediaLibrary(context: Context) {
  ...
  @DoNotStrip
  fun getAssets(params: JSONObject, callback: (String) -> Unit) {
    scope.launch {
  ...
  @DoNotStrip
  fun getCollections(callback: (String) -> Unit) {
  ...
  @DoNotStrip
  fun getAsset(id: String, callback: (String) -> Unit) {
    scope.launch {
      val contentResolver = context.contentResolver
  ...
  @DoNotStrip
  fun saveToLibrary(params: String, callback: (String) -> Unit) {
    scope.launch {
  ...
  @DoNotStrip
  fun fetchVideoFrame(params: String, callback: (String) -> Unit) {
    scope.launch {
      val input = params.asJsonInput()
  ...
  @DoNotStrip
  fun combineImages(params: String, callback: (String) -> Unit) {
    scope.launch {
      val input = params.asJsonInput()
  ...
  @DoNotStrip
  fun imageResize(params: String, callback: (String) -> Unit) {
    scope.launch {
      val input = params.asJsonInput()
  ...
  @DoNotStrip
  fun imageCrop(params: String, callback: (String) -> Unit) {
    scope.launch {
      val input = params.asJsonInput()
  ...
  @DoNotStrip
  fun imageSizes(params: String, callback: (String) -> Unit) {
    scope.launch {
      val input = params.asJsonInput()
  ...
  @DoNotStrip
  fun downloadAsBase64(params: String, callback: (String) -> Unit) {
    scope.launch {
      val input = params.asJsonInput()
